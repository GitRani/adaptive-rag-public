...
from config.model_config import Claude, Ollama
...
def vector_websearch_chain():
    ...
    structed_llm = Ollama(schema=RouteQuery).get_structed_model()
...
def grade_hallucination_chain():
    ...
    structed_llm = Ollama(schema=GradeHallucinations).get_structed_model()
...
def grade_answer_chain():
    ...
    structed_llm = Ollama(schema=GradeQuestionAnswer).get_structed_model()
...
def grade_documents_chain():
    ...
    structed_llm = Ollama(schema=GradeDocuments).get_structed_model()
